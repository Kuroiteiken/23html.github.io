...
| **Items and equipment** | ~308 of 544        | No drop, recipe, or vendor source. `wpn.trch`, the torch, now drops from the upper catacombs — it was the only light source in the game that nothing sold. Still unsourced: 7 keys, 6 essences, 5 masks, 3 medals, 16 elemental charms, ~35 weapons, roughly 150 foods. All six dojo rank medals carry a worn effect now: they had no stats, no `oneq` and a placeholder description, so the level-45 tier's reward did nothing, and the White Boar and White Jade medals fill the level-40 and level-50 tiers -- the level-40 tier had been handing out a second copy of the Sword Medal the training quest already gives. Three of the fourteen shields now come from the dojo ladder; the Hoplite, Knight and Dread shields had been listed as rare with no stats at all, so the level 35 reward defended exactly as well as an empty hand. |
